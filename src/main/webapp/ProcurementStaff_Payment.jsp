...
<title>Procurement Payment</title>
          ...
          <div class="container-fluid" style="margin-bottom: 10px;min-height:510px;overflow: auto">
             ...
             <table style="border-weight:thick;border-color:black;text-align:center;" cellpadding="20px" cellspacing="20px" align="center" border="1"  >
            	<tr>
                    ...
                    <th style="font=weight:bold;">Make Payment</th>
                  ...
                  <% if(RetreiveDAO.retreiveAllPayment() == null) { %>
                	  ...
                	  <br>
                	  <h4 style="margin-left: 680px">No payment Requests Found</h4>
                   <%
                	  ...
                	  <%if(payment.getStatus().contains("Made")) { %> 
                	  <td>Payment has been made</td>
                	  ...
                	  <td>
                	  		<form action="ProcurementEmployeeMakePayment" method="post">
                	  		<input name="paymentId" id="paymentId" value="<%=payment.getPaymentId() %>" hidden>
                	  		 <input name="username" id="paymentId" value="<%=employee.getUsername()%>" hidden>
                	  		 <input type="submit" class="nav-link nav_change" style="border-radius: 15px; text-align: center;font-weight:bold;color::#fd4f00;background-color:white;width:100px;border-weight:10px;border-color:#111E6C" value="Pay">
                	  		</form>
                	  </td>
                 <% 
                	  }
