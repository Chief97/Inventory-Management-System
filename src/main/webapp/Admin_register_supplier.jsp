...
<title>Register a Supplier</title>
	...
	<script type="text/javascript">
		  function autoFill() {
		    ...
		    document.getElementById('email').value = "atheeqmahroof@gmail";
                ...
                <form action="AdminCreateSupplier" method="post">
                    <div style="float: left; margin-right: 5px;">
                        <div style="width: 550px; float: left; padding: 5px; border-width: 1px; border-style: solid; border-color: #111E6C; margin-bottom: 5px;">
                            ...
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                <label class="col-4 col-form-label" for="EmpForm01BasicDetails02">Company Name: *</label>
                                <div class="col-8">
                                	<input type="text" class="form-control" id="companyName" required="required" name="companyName">
                                </div>
                            </div>
                        ...
                        <div style="width: 550px; padding: 5px; padding: 5px; border-width: 1px; border-style: solid; border-color: #111E6C; clear: both">
                            ...
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                ...
                                <div class="col-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="addressLine1" required="required" placeholder="No 53 " name="addressLine1">
                                    </div>
                                    <div class="form-group">
                                        <label for="EmpForm01ContactDetails02">Line 02: *</label>
                                        <input type="text" class="form-control" id="addressLine2" required="required" placeholder="Street Name" name="addressLine2">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                <label class="col-2 col-form-label" for="addressLine1">City: *</label>
                                <div class="col-8">
                                    <input type="text" class="form-control" id="city" required="required" name="city">
                                </div>
                            ...
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                <label class="col-4 col-form-label" for="EmpForm01ContactDetails08">Company Email: *</label>
                                <div class="col-8">
                    ...
                    <div style="float: left;">
                        <div style="width: 550px; padding: 5px; border-width: 1px; border-style: solid; border-color: #111E6C; margin-bottom: 5px;">
                            <h5>Item</h5>
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                <label class="col-4 col-form-label" for="EmpForm01Identification01">Item offered: *</label>
                                
                                <div class="col-8">
                                    <select class="custom-select mr-sm-2" required="required" id="itemName" name="itemName">
                            ...
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                <label class="col-4 col-form-label" for="EmpForm01Identification04">Unit Price: *</label>
                                <div class="col-8">
                                    <input type="number" class="form-control" required="required" id="itemPrice" name="itemPrice">
                                </div>
                            </div>
                        </div>
