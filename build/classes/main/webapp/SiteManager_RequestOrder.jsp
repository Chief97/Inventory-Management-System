...
<title>Site Manager Request Orders</title>
        ...
        <!-- Body ---------------------------------------------------------------------------------------------------------------- -->
          ...
          <br>
          	...
          	<h4>Site Name : <%=RetreiveDAO.getSingleSiteById(employee.getSite()).getSiteName() %></h4>
        	     ...
        	     <form action="SiteManagerRequestOrder" method="POST">
                <br>
                    <div style="float: left; margin-right: 5px;margin-left: 500px">
                        <div style="width: 550px; float: left; padding: 5px; border-width: 1px; border-style: solid; border-color: #111E6C; margin-bottom: 5px;">
                            <h5>Request an Item from the procurement</h5>
                            ...
                            <div class="form-group row" style="padding: 4px; padding-left: 16px">
                                ...
                                <div class="col-8">
                                	<input type="Date" class="form-control" min =<%=date%> id="deliveryDate" required="required" name="deliveryDate">
                                </div>
                            </div>
			            ...
			            <div style="clear: both; float: left; margin-top: 20px;margin-left: 650px">
			                <div class="form-group row">
			                    <div>
			                        ...
			                        <input type="submit" value="Request Item" style="background-color: white; border-radius: 10px; color: black; border-color: #111E6C; border-width: 1px; border-style: solid; font-size: 22px; margin-right: 20px;color: #111E6C"/>
