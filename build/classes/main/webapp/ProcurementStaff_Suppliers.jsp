...
<title>Procurement View Suppliers</title>
	...
	<nav class="navbar fixed-top navbar-expand-md navbar-dark fixed-stuff">
        ...
        <!-- Body ---------------------------------------------------------------------------------------------------------------- -->
          ...
          <div class="container-fluid" style="margin-bottom: 10px;min-height:510px;overflow: auto">
            <%
            	if(RetreiveDAO.retreiveAllItem() == null){%>
            	 <br>
            	...
            	<%	
            	 ...
            	 <%
            		...
            		<br>
            		  <h4 style="margin-left: 60px">Item Id : <%=item.getItemId() %></h4>
                	  <h4 style="margin-left: 60px">Item Name : <%=item.getItemName() %></h4>
            		...
            		<tr>
                    <th style="font=weight:bold;">Supplier Id</th>
                    ...
                    <%if(RetreiveDAO.retreiveAllSuppliersByItem(item.getItemId()) == null){
                    	%> 
                    	</table>
                	  <br>
                	  <h4 style="margin-left: 680px">No Suppliers found</h4>
                    	<%
                    } else { 
                    ...
                    <tr>
                    	...
                    	<td><%=supplier.getAddressStreet1() %>,<%=supplier.getAddressStreet2() %>, <%=supplier.getCity() %></td>
